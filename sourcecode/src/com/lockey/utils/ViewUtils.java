 ...
 * <li>{@link ViewUtils#getListViewHeightBasedOnChildren(android.widget.ListView)}</li>
 * <li>{@link ViewUtils#getAbsListViewHeightBasedOnChildren(android.widget.AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>set view height</strong>
 * <li>{@link ViewUtils#setViewHeight(android.view.View, int)} set view height</li>
 * <li>{@link ViewUtils#setListViewHeightBasedOnChildren(android.widget.ListView)}</li>
 * <li>{@link ViewUtils#setAbsListViewHeightBasedOnChildren(android.widget.AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>get other info</strong>
 * <li>{@link ViewUtils#getGridViewVerticalSpacing(android.widget.GridView)} get GridView vertical spacing</li>
 * </ul>
 * <ul>
 * <strong>set other info</strong>
 * <li>{@link ViewUtils#setSearchViewOnClickListener(android.view.View, android.view.View.OnClickListener)}</li>
 * </ul>
 * 
