...
public class JSONUtils {
     ...
     *         <li>return {@link JSONUtils#getLong(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see JSONUtils#getLong(org.json.JSONObject, String, Long)
     */
    public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtils#getInt(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see JSONUtils#getInt(org.json.JSONObject, String, Integer)
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtils#getDouble(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see JSONUtils#getDouble(org.json.JSONObject, String, Double)
     */
    public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtils#getString(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtils#getStringArray(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtils#getStringList(org.json.JSONObject, String, java.util.List)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonData is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtils#getJSONObject(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtils#getJSONArray(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtils#getBoolean(org.json.JSONObject, String, Boolean)}</li>
     *         </ul>
     */
     ...
     *         <li>return {@link JSONUtils#getMap(org.json.JSONObject, String)}</li>
     *         </ul>
     */
     ...
     *         <li>return {@link JSONUtils#parseKeyAndValueToMap(org.json.JSONObject)}</li>
     *         </ul>
     */
